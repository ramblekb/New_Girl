...
module.exports = function (app) {
  ...
  app.get("/api/records", function (req, res) {
    db.sequelize.query("select Username, Email, Artist, Album, Year, WillingToTrade from Record r inner join User u on u.id = r.UserId")
  ...
  app.get("/api/records/artist/:artist", function (req, res) {
    db.sequelize.query("select Username, Email, Artist, Album, Year, WillingToTrade from Record r inner join User u on u.id = r.UserId Where Artist=" + req.params.artist)
      .then(function (dbRecord) {
        res.json(dbRecord);
      });
  });
  ...
  app.get("/api/records/album/:album", function (req, res) {
    db.sequelize.query("select Username, Email, Artist, Album, Year, WillingToTrade from Record r inner join User u on u.id = r.UserId Where Album=" + req.params.album)
      .then(function (dbRecord) {
        res.json(dbRecord);
      });
  });
